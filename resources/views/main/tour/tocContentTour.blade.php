...
@if($flagQcCombo==true)
    <div class="serviceRelatedSidebarBox">
        <div class="serviceRelatedSidebarBox_title callUseService">
            ...
            @endphp
        <h2><i class="fa-solid fa-star"></i> Nếu bạn yêu thích việc du lịch tự túc, {{ config('main.name') }} cũng có các Combo gồm khách sạn + {{ $flagIsland==true ? 'vé tàu cao tốc' : 'vé dịch vụ' }} nữa nhé!</h2>
        </div>
