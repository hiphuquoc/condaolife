            ...
            <div class="modalHotelFacilities_box_body">
                <div class="hotelFacilitiesTab">
                    ...
                    <div class="hotelFacilitiesTab_body customScrollBar-y">
                        @foreach($arrayFacilities as $key => $group)
                            <div class="hotelFacilitiesTab_body_tab selected">
                                {{-- @php
                                    switch ($key) {
                                ...
                                {{-- <div class="hotelFacilitiesTab_body_tab_list maxLine_2">
                                    
                                </div>
                                <div class="hotelFacilitiesTab_body_tab_button" onClick="openCloseModal('modalHotelFacilities');tabFacilities('hotel_info_feature');">Hiển thị thêm</div> --}}
                            </div>
                        @endforeach
