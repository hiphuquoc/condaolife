            ...
            <div class="pageContent_body">
                <div class="bookingForm">
                    ...
                    <div class="bookingForm_item">
                        ...
                        <div>Thông tin booking của Quý khách đã được thông báo đến nhân viên {{ config('main.name') }}. Sau khi kiểm tra xong nhân viên sẽ gửi xác nhận vào Email hoặc Zalo và liên hệ cho Quý khách.</div>
                        </div>
                    </div>
