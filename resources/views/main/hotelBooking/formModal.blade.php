    ...
    <div class="bookingModal_box_body_item_body">
        ...
        <div class="bookingModal_box_body_item_body_item">
            <div class="inputWithLabelInside date">
                ...
                <input type="text" class="form-control flatpickr-disabled-range flatpickr-input active" id="modal_range_time" name="modal_range_time" value="{{ date('Y-m-d', $checkIn) .' to '. date('Y-m-d', $checkOut)}}" />
            </div>
        </div>
