<head>
  ...
  <meta name="description" content="Trang quản trị nội dung ®{{ config('main.name') }}">
  <meta name="keywords" content="Trang quản trị nội dung ®{{ config('main.name') }}">
  <meta name="author" content="{{ config('main.name') }}">
  <title>Trang quản trị nội dung ®{{ config('main.name') }}</title>
