...
Route::prefix('he-thong')->group(function(){
    ...
    Route::middleware('auth', 'role:admin')->group(function (){
        ...
        Route::prefix('feedback')->group(function(){
            Route::get('/', [AdminFeedbackController::class, 'list'])->name('admin.feedback.list');
            Route::post('/create', [AdminFeedbackController::class, 'create'])->name('admin.feedback.create');
            Route::get('/view', [AdminFeedbackController::class, 'view'])->name('admin.feedback.view');
            Route::post('/update', [AdminFeedbackController::class, 'update'])->name('admin.feedback.update');
            /* Delete AJAX */
            Route::get('/delete', [AdminFeedbackController::class, 'delete'])->name('admin.feedback.delete');
        });
        /* ===== REDIRECT ===== */
